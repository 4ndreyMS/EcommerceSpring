...
public class OrderWithUserDto {
    ...
    public OrderWithUserDto(long id, OrderStatusEnum orderStatus, String addres1, String addres2, String city, String state, String zipCode, String cardNumber, String cardType, String expiryDate, double totalAmount, double totalWithoutTax, double taxAmount, long totalItemsAmount, String creationDate, List<OrderItemDto> orderedItems) {
        this.id = id;
